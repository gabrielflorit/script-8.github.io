...
const mapDispatchToProps = dispatch => ({
  ...
  saveGist: ({ game, token, gist, sprites, phrases, chains, songs }) =>
    dispatch(saveGist({ game, token, gist, sprites, phrases, chains, songs })),
...
class Menu extends Component {
  ...
  save () {
    ...
    saveGist({ token, game, sprites, phrases, chains, songs, gist })
  }
        ...
        <ul>
          <li>
            ...
            <ul className='dropdown'>
              ...
              <li>
                <button className='button' disabled={!enableRecordToBlank}>
                  Record to blank
                </button>
              </li>
            </ul>
